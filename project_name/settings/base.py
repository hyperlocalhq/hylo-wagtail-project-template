...
INSTALLED_APPS = [
    "{{ project_name }}.apps.forms",
    "{{ project_name }}.apps.home",
    "{{ project_name }}.apps.images",
    "{{ project_name }}.apps.navigation",
    "{{ project_name }}.apps.news",
    "{{ project_name }}.apps.search",
    "{{ project_name }}.apps.standardpages",
    "{{ project_name }}.apps.users",
    "{{ project_name }}.apps.utils",
